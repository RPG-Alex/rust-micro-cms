//Putting external cargo dependencies here, only needed for this library
...
//just calling this tezt for now. Need to separate each db query into its own public function. Possibly use a constructor for DB Queries? 
pub fn test() -> Result<()> {
